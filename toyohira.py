...
df_2019 = pd.read_csv(r".\yosoku\data\2019toyohira.csv", encoding="utf8")
df_2018 = pd.read_csv(r".\yosoku\data\2018toyohira.csv", encoding="utf8")
df_2017 = pd.read_csv(r".\yosoku\data\2017toyohira.csv", encoding="utf8")
