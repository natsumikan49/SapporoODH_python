...
df_2019 = pd.read_csv(r".\yosoku\data\2019atubetu.csv", encoding="utf8", sep="\\t")
df_2018 = pd.read_csv(r".\yosoku\data\2018atsubetsu.csv", encoding="utf8")
df_2017 = pd.read_csv(r".\yosoku\data\2017atsubetsu.csv", encoding="utf8")
