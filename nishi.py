...
df_2019 = pd.read_csv(r".\yosoku\data\2019nisi.csv", encoding="shift-jis")
df_2018 = pd.read_csv(r".\yosoku\data\2018nishi.csv", encoding="utf8")
df_2017 = pd.read_csv(r".\yosoku\data\2017nishi.csv", encoding="utf8")
