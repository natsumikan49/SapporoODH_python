...
df_2019 = pd.read_csv(r".\data\2019kita.csv", encoding="utf8")
df_2018 = pd.read_csv(r".\data\2018kita.csv", encoding="utf8")
df_2017 = pd.read_csv(r".\data\2017kita.csv", encoding="utf8")
