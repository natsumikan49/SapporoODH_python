...
df_2019 = pd.read_csv(r".\data\2019minami.csv", encoding="utf8")
df_2018 = pd.read_csv(r".\data\2018minami.csv", encoding="utf8")
df_2017 = pd.read_csv(r".\data\2017minami.csv", encoding="utf8")
