...
df_2019 = pd.read_csv(r".\data\2019chuou.csv", encoding="shift-jis")
df_2018 = pd.read_csv(r".\data\2018chuo.csv", encoding="utf8")
df_2017 = pd.read_csv(r".\data\2017chuou.csv", encoding="utf8")
